class StoryPointsAnalyzer < Formula
  ...
  url "https://github.com/joaoparis/story-points-analyzer/archive/refs/tags/v1.1.4.tar.gz"
  sha256 "4977f9f83bfc3000c8e229e58a9819143d626af5c6c194e2d95940915ecb4afe"
  license "MIT"
  ...
  test do
    assert_match "story-points-analyzer 1.1.4", shell_output("#{bin}/story-points-analyzer --version")
